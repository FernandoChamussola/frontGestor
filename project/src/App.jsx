...
import DetalhesDivida from './pages/DetalhesDivida'
import EditDivida from './pages/EditDivida'
  ...
  return (
    <Box minH="100vh">
      <Routes>
        ...
        <Route path='/dividasDetalhes/:id' element={<DetalhesDivida />} />
        <Route path="/editar/:id" element={<EditDivida />} />
      </Routes>
    </Box>
  )
}
